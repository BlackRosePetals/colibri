...
- `repack_fp8_passthrough.py`: fmt=8 repack (byte-preserved FP8, resident kinds and
  routed experts; `--mtp` for the multi-token-prediction head; see the module
  docstring -- synthetic-fixture-tested only, no real-shard runs yet)
